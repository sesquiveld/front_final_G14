...
import CrearBoletinD from "./components/PanelDocente/CrearBoletinD.js";
import VerBoletinD  from "./components/PanelDocente/VerBoletinD.js";
import ActualizarBoletinD from "./components/PanelDocente/ActualizarBoletinD.js";
import VerBoletinA  from "./components/PanelAcudiente/VerBoletinA.js";
import MenuBoletinD from "./components/PanelDocente/MenuBoletinD.js";
    ...
    return (
        <Router>
            <Routes>
                ...
                <Route path="/crear-boletinD" exact element={<CrearBoletinD/>} />
                <Route path="/ver-boletinD" exact element={<VerBoletinD/>} />
                <Route path="/menu-boletinD" exact element={<MenuBoletinD/>} />
                <Route path="/actualizar-boletinD/:idBoletin" exact element={<ActualizarBoletinD/>} />
                <Route path="/ver-boletinA" exact element={<VerBoletinA/>} />
